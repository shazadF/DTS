...
namespace DTS.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        ApplicationDbContext db = new ApplicationDbContext();      //new append
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            var user = new ApplicationUser() { UserName = model.UserName, Email = model.Email, CompanyId = model.CompanyId };
